	...
	function Link() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Link.__proto__ || Object.getPrototypeOf(Link)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (event) {
			...
			var _this$context = _this.context,
			    goTo = _this$context.goTo,
			    goReplace = _this$context.goReplace,
			    location = _this$context.location;
			var _location$basename = location.basename,
			    basename = _location$basename === undefined ? '' : _location$basename;
	...
	_createClass(Link, [{
		...
		value: function render() {
			...
			var _props = this.props,
			    ...
			    other = _objectWithoutProperties(_props, ['to', 'children', 'tagName']);
