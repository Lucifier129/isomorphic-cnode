...
/***/ function(module, exports, __webpack_require__) {
	...
	var _model = __webpack_require__(417);
	    ...
	    function _class() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(_ref, [this].concat(args))), _this), _this.name = 'Detail', _this.View = _view2.default, _this.actions = actions, _this.initialState = {
	                        ...
	                        while (1) {
	                            switch (_context.prev = _context.next) {
	                                ...
	                                case 2:
	                                    ...
	                                    UPS_REPLAY = _store$actions.UPS_REPLAY;
	            ...
	            showReply: function showReply(_ref5) {
	                ...
	                var curReplyId = _store$getState2.curReplyId;
	                var topic = _store$getState2.topic;
	                ...
	                var _topic$replies$filter2 = _slicedToArray(_topic$replies$filter, 1);

	                var author = _topic$replies$filter2[0].author;
